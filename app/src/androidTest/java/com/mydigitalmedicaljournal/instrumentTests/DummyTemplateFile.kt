...
class DummyTemplateFile(private val fileName: String, private val directories: Array<String> = arrayOf()) {
    private val filePath = FileHelper(fileName, Utils.CONTEXT, directories)
    //TODO this could be better
    fun get(): TemplateManager {
        filePath.write("{\"data\":[],\"id\":\"${fileName}\",\"name\":\"another test\",\"time\":\"DURATION\"}")
