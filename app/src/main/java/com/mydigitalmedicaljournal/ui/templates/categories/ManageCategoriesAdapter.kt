...
import java.util.*
class ManageCategoriesAdapter(private val templateList: MutableList<TemplateList.FileList>, private var savedList: MutableList<UUID>) : RecyclerView.Adapter<ViewHolder>() {
