...
class ManageCategoryTemplatesFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val viewAdapter = Adapter(TemplateList(requireContext()).get(), category?.templates, requireContext())
    ...
    class Adapter(private val templateList: List<FileList>, savedList: MutableList<UUID>?, context: Context) : EmptyAdapter() {
